...
from PyQt5.Qt import QMessageBox, QPushButton, QLabel, QLineEdit, Qt, \
...
class PluginObject(object):
   ...
   def __init__(self, main):
      ...
      self.dustLimitText.textChanged.connect(updateDustLimit)
      ...
      self.main.walletsView.clicked.connect(updateDustLimit)
